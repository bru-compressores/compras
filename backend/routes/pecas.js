...
router.post('/', async (req, res) => {
  try {
    ...
    await qr(db, `INSERT INTO pecas_os (os_id,codigo,descricao,quantidade,preco_unitario,preco_cotado,preco_fechado,fornecedor_id,status_entrega,data_entrega_prevista,numero_rastreio,observacoes,transporte,codigo_fabricante) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?)`,
      os_id, codigo||null, descricao, quantidade||1, preco_unitario||null, preco_cotado||null, preco_fechado||null, fornecedor_id||null, status_entrega||'Pendente', data_entrega_prevista||null, numero_rastreio||null, observacoes||null, transporte||null, codigo_fabricante||null);
